...
def test_load_commands_from_file(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
...
@given(commands=command_set)
def test_safe_and_load_commands(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
...
def test_persistent_command_set_add(command_file_factory: command_file_factory_type, command_to_add: Command, commands: set[Command]) -> None:
    command_file = command_file_factory(commands)
...
def test_persistent_command_set_remove(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
    command_file = command_file_factory(commands)
