...
def test_add_command(command_file_factory: command_file_factory_type, command_to_add: Command, commands: set[Command]) -> None:
...
def test_add_duplicated_command(command_file_factory: command_file_factory_type, duplicated_command: Command,
                                commands: set[Command]) -> None:
...
def test_add_command_with_same_alias(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
    command_file = command_file_factory(commands)
...
@given(commands=non_empty_command_set)
def test_get_command_by_alias(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
    command_file = command_file_factory(commands)
    command_ = commands.pop()
...
@given(commands=non_empty_command_set)
def test_get_command_by_alias_non_existing(command_file_factory: command_file_factory_type,
                                           commands: set[Command]) -> None:
    command_ = commands.pop()
    command_file = command_file_factory(commands)
...
def test_list_commands(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
    command_file = command_file_factory(commands)
    assert list_commands(command_file) == load_from_command_file(command_file)


@given(commands=non_empty_command_set)
def test_remove_existing_command(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
    command_file = command_file_factory(commands)
...
@given(commands=non_empty_command_set)
def test_remove_non_existing_command(command_file_factory: command_file_factory_type, commands: set[Command]) -> None:
    command_to_remove = commands.pop()
    command_file = command_file_factory(commands)
    remove_command(command_to_remove, command_file)
    assert load_from_command_file(command_file) == commands
